...
Dota2.Dota2Client.prototype.spectateFriendGame = function(steam_id, callback){
    ...
    var payload = new Dota2.schema.CMsgSpectateFriendGame(steam_id);

    this.sendToGC(  Dota2.schema.EDOTAGCMsg.k_EMsgGCSpectateFriendGame,
                    payload,
...
var onSpectateFriendGameResponse = function onSpectateFriendGameResponse(message, callback) {
    callback = callback || null;
    var spectateFriendGameResponse = Dota2.schema.CMsgSpectateFriendGameResponse.decode(message);

    const server_steamid = spectateFriendGameResponse.server_steamid;

    if (server_steamid !== null) {
...
handlers[Dota2.schema.EDOTAGCMsg.k_EMsgGCSpectateFriendGameResponse] = onSpectateFriendGameResponse;
